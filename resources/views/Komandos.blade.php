...
<body>
        ...
        <nav class="flex justify-between items-center w-[92%] mx-auto my-2">
            ...
            <div class=" nav-links duration-500 md:static absolute md:min-h-fit min-h-[60vh] left-0 top-[-100%] md:w-auto w-full flex items-center px-5">
                <ul class="flex md:flex-row flex-col md:items-center md:gap-[4vw] gap-8 ">
                    <li>
                        <a href="Komandos" class="hover:text-gray-500 font-bold" >Komandos</a>
                    </li>
                    <li>
    ...
    <div class="mb-4 mx-auto w-1/2">
        <div class="grid gap-4 mt-2">
            @foreach ($komanda as $team)
                <a href="/Komandos/{{ $team->id }}" class="block ">
                    <div class="p-4 bg-white rounded shadow-xl">
                        <p><strong>Komanda:</strong> {{ $team->komandos_pavadinmas }}</p>
